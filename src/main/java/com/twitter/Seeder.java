...
//	    // ----- TWEETS -----
        ...
        user1.setCreatedTweets(user1Tweets);
        userRepository.saveAndFlush(user1);

        List<Tweet> user2Tweets = List.of(tweet3, tweet4);
        user2.setCreatedTweets(user2Tweets);
        userRepository.saveAndFlush(user2);

        List<Tweet> user3Tweets = List.of(tweet5, tweet6);
        user3.setCreatedTweets(user3Tweets);
...
//        user2.getLikedTweets().addAll(user1Tweets);
//        user2.getLikedTweets().addAll(user2Tweets);
//        userRepository.saveAndFlush(user2);
